...
// Example usage:
showItem(player1, 2); // Display the second item in player1's inventory
var addItem = function(player, itemTitle) {
  player.items.push(itemTitle);
  console.log(itemTitle + " added to " + player.name + "'s inventory.");
};

// Example usage:
addItem(player1, "a mysterious key");
showPlayerInfo(player1, "="); // Display updated player information
